...
static const u16 sMonMarkings_Pal[] = INCGFX_U16("graphics/misc/mon_markings.png", ".gbapal");
static const u16 sMonMarkings_Gfx[] = INCGFX_U16("graphics/misc/mon_markings.png", ".4bpp");
