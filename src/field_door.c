...
static const u8 sDoorAnimTiles_UnusedTop[] = INCGFX_U8("graphics/door_anims/unused_top.png", ".4bpp");
static const u8 sDoorAnimTiles_Empty32[256] = {};
static const u8 sDoorAnimTiles_UnusedMidTop[] = INCGFX_U8("graphics/door_anims/unused_midtop.png", ".4bpp");
static const u8 sDoorAnimTiles_Empty33[256] = {};
static const u8 sDoorAnimTiles_UnusedMidBottom[] = INCGFX_U8("graphics/door_anims/unused_midbottom.png", ".4bpp");
static const u8 sDoorAnimTiles_Empty34[256] = {};
static const u8 sDoorAnimTiles_UnusedBottom[] = INCGFX_U8("graphics/door_anims/unused_bottom.png", ".4bpp");
