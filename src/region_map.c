...
static const u16 sTopBar_Pal[] = INCGFX_U16("graphics/region_map/top_bar.pal", ".gbapal"); // Palette for the top bar and dynamic text color
static const u16 sMapCursor_Pal[] = INCGFX_U16("graphics/region_map/cursor.pal", ".gbapal");
static const u16 sPlayerIcon_RedPal[] = INCGFX_U16("graphics/region_map/player_icon_red.pal", ".gbapal");
static const u16 sPlayerIcon_LeafPal[] = INCGFX_U16("graphics/region_map/player_icon_leaf.pal", ".gbapal");
static const u16 sMiscIcon_Pal[] = INCGFX_U16("graphics/region_map/misc_icon.pal", ".gbapal"); // For dungeon and fly icons
static const u16 sRegionMap_Pal[] = INCGFX_U16("graphics/region_map/region_map.pal", ".gbapal");
static const u16 sUnusedPalette[] = { RGB(0, 0, 31), RGB(0, 12, 31), RGB_WHITE, RGB_WHITE };
static const u16 sSwitchMapCursor_Pal[] = INCGFX_U16("graphics/region_map/switch_map_cursor.pal", ".gbapal");
static const u16 sMapEdge_Pal[] = INCGFX_U16("graphics/region_map/map_edge.png", ".gbapal");
static const u32 sSwitchMapCursorLeft_Gfx[] = INCGFX_U32("graphics/region_map/switch_map_cursor_left.png", ".4bpp.lz");
static const u32 sSwitchMapCursorRight_Gfx[] = INCGFX_U32("graphics/region_map/switch_map_cursor_right.png", ".4bpp.lz");
static const u32 sMapCursor_Gfx[] = INCGFX_U32("graphics/region_map/cursor.png", ".4bpp.lz");
static const u32 sPlayerIcon_Red[] = INCGFX_U32("graphics/region_map/player_icon_red.png", ".4bpp.lz");
static const u32 sPlayerIcon_Leaf[] = INCGFX_U32("graphics/region_map/player_icon_leaf.png", ".4bpp.lz");
static const u32 sRegionMap_Gfx[] = INCGFX_U32("graphics/region_map/region_map.png", ".4bpp.lz");
static const u32 sMapEdge_Gfx[] = INCGFX_U32("graphics/region_map/map_edge.png", ".4bpp.lz");
static const u32 sSwitchMapMenu_Gfx[] = INCGFX_U32("graphics/region_map/switch_map_menu.png", ".4bpp.lz");
static const u32 sKanto_Tilemap[] = INCGFX_U32("graphics/region_map/kanto.bin", ".lz");
static const u32 sSevii123_Tilemap[] = INCGFX_U32("graphics/region_map/sevii_123.bin", ".lz");
static const u32 sSevii45_Tilemap[] = INCGFX_U32("graphics/region_map/sevii_45.bin", ".lz");
static const u32 sSevii67_Tilemap[] = INCGFX_U32("graphics/region_map/sevii_67.bin", ".lz");
static const u32 sMapEdge_Tilemap[] = INCGFX_U32("graphics/region_map/map_edge.bin", ".lz");
static const u32 sSwitchMap_KantoSeviiAll_Tilemap[] = INCGFX_U32("graphics/region_map/switch_map_kanto_sevii_all.bin", ".lz");
static const u32 sSwitchMap_KantoSevii123_Tilemap[] = INCGFX_U32("graphics/region_map/switch_map_kanto_sevii_123.bin", ".lz");
static const u32 sSwitchMap_KantoSeviiAll2_Tilemap[] = INCGFX_U32("graphics/region_map/switch_map_kanto_sevii_all2.bin", ".lz");
static const u32 sMapEdge_TopLeft[] = INCGFX_U32("graphics/region_map/map_edge_top_left.png", ".4bpp.lz");
static const u32 sMapEdge_TopRight[] = INCGFX_U32("graphics/region_map/map_edge_top_right.png", ".4bpp.lz");
static const u32 sMapEdge_MidLeft[] = INCGFX_U32("graphics/region_map/map_edge_mid_left.png", ".4bpp.lz");
static const u32 sMapEdge_MidRight[] = INCGFX_U32("graphics/region_map/map_edge_mid_right.png", ".4bpp.lz");
static const u32 sMapEdge_BottomLeft[] = INCGFX_U32("graphics/region_map/map_edge_bottom_left.png", ".4bpp.lz");
static const u32 sMapEdge_BottomRight[] = INCGFX_U32("graphics/region_map/map_edge_bottom_right.png", ".4bpp.lz");
static const u32 sDungeonIcon[] = INCGFX_U32("graphics/region_map/dungeon_icon.png", ".4bpp.lz");
static const u32 sFlyIcon[] = INCGFX_U32("graphics/region_map/fly_icon.png", ".4bpp.lz");
static const u32 sBackground_Gfx[] = INCGFX_U32("graphics/region_map/background.png", ".4bpp.lz");
static const u32 sBackground_Tilemap[] = INCGFX_U32("graphics/region_map/background.bin", ".lz");
...
static const struct DungeonMapInfo sDungeonInfo[] = {
    {
        ...
        .name = sMapsecName_LAVENDER_TOWER,
