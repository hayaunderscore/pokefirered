const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(RAINER, gMonFrontPic_Rainer),
    SPECIES_SPRITE(SAPUSAUR, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(CHARCOLT, gMonFrontPic_DoubleQuestionMark),
