...
static const u16 sEvolutionSparklesPalData[] = INCGFX_U16("graphics/evolution_scene/sparkle.png", ".gbapal");
static const u32 sEvolutionSparklesTileData[] = INCGFX_U32("graphics/evolution_scene/sparkle.png", ".4bpp.lz");
