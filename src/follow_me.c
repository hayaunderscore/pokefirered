...
static const struct FollowerSpriteGraphics gFollowerAlternateSprites[] =
{
    ...
    [0] = 
    {
        .normalId = OBJ_EVENT_GFX_BLUE,
        .machBikeId = OBJ_EVENT_GFX_BLUE,
        .acroBikeId = OBJ_EVENT_GFX_BLUE,
        .surfId = OBJ_EVENT_GFX_BLUE,
        .underwaterId = OBJ_EVENT_GFX_BLUE,
    },
