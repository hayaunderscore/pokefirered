const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(RAINER, gMonShinyPalette_Rainer),
    SPECIES_SHINY_PAL(SAPUSAUR, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(CHARCOLT, gMonShinyPalette_DoubleQuestionMark),
