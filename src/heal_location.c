...
void SetWhiteoutRespawnWarpAndHealerNpc(struct WarpData * warp)
{
    ...
    else
    {
        ...
        else if (sWhiteoutRespawnHealCenterMapIdxs[healLocationIdx - 1][0] == MAP_GROUP(MAP_SUNKEN_ANNE_2F_HEAL_SPOT) && sWhiteoutRespawnHealCenterMapIdxs[healLocationIdx - 1][1] == MAP_NUM(MAP_SUNKEN_ANNE_2F_HEAL_SPOT))
        {
        	warp->x = 4;
         	warp->y = 6;
        }
