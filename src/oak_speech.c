...
static const u32 sControlsGuide_PikachuIntro_Background_Tiles[] = INCGFX_U32("graphics/oak_speech/bg_tiles.png", ".4bpp.lz");
static const u32 sPikachuIntro_Background_Tilemap[] = INCGFX_U32("graphics/oak_speech/pikachu_intro/tilemap.bin", ".lz");
...
static const u32 sPikachuIntro_PikachuBody_Gfx[] = INCGFX_U32("graphics/oak_speech/pikachu_intro/body.png", ".4bpp.lz");
static const u32 sPikachuIntro_PikachuEars_Gfx[] = INCGFX_U32("graphics/oak_speech/pikachu_intro/ears.png", ".4bpp.lz");
static const u32 sPikachuIntro_PikachuEyes_Gfx[] = INCGFX_U32("graphics/oak_speech/pikachu_intro/eyes.png", ".4bpp.lz");
