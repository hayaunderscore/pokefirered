...
struct SaveBlock2
{
    ...
    /*0x090*/ u8 optionsQuestLog:1;
    		  u8 optionsLevelCaps:2; // OPTIONS_LEVEL_CAP_MODE_[SOFT/HARD/NONE]
    ...
    /*0xB44*/ u8 filler_B20[0x400 - 36]; // Thank arceus for filler bytes that no one uses
    /*0xB20*/ struct Follower follower;
