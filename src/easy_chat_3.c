...
static const u16 sRectangleCursor_Pal[] = INCGFX_U16("graphics/easy_chat/rectangle_cursor.png", ".gbapal");
static const u16 sTriangleCursor_Gfx[] = INCGFX_U16("graphics/easy_chat/triangle_cursor.png", ".4bpp");
static const u16 sScrollIndicator_Gfx[] = INCGFX_U16("graphics/easy_chat/scroll_indicator.png", ".4bpp");
static const u16 sStartSelectButtons_Gfx[] = INCGFX_U16("graphics/easy_chat/start_select_buttons.png", ".4bpp");
