...
enum FlagsVarsMenu
{
    ...
    DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_QUEST_LOG,
...
static void DebugAction_FlagsVars_QuestLogOnOff(u8 taskId);
...
static const u8 sDebugText_Continue[] =      _("Continue…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
// Main Menu
static const u8 sDebugText_Utilities[] =        _("Utilities…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_PartyBoxes[] =       _("Party/Boxes…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Scripts[] =          _("Scripts…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_FlagsVars[] =        _("Flags & Vars…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Give[] =             _("Give X…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Fill[] =             _("Fill PC/Pockets…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
...
static const u8 sDebugText_Util_WarpToMap_SelectMapGroup[] = _("Group: {STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n\n{STR_VAR_3}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_Util_WarpToMap_SelectMap[] =      _("Map: {STR_VAR_1}{CLEAR_TEXT_TO 90}\nMapSec:{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}\n{STR_VAR_3}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_Util_WarpToMap_SelectWarp[] =     _("Warp:{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_3}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_Util_WarpToMap_SelMax[] =         _("{STR_VAR_1}/{STR_VAR_2}");
static const u8 sDebugText_Util_SaveBlockSpace[] =           _("SaveBlock Space…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Util_ROMSpace[] =                 _("ROM Space…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Util_Weather[] =                  _("Set weather…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Util_Weather_ID[] =               _("Weather Id: {STR_VAR_3}\n{STR_VAR_1}\n{STR_VAR_2}");
static const u8 sDebugText_Util_WatchCredits[] =             _("Watch Credits…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
...
// Flags/Vars Menu
static const u8 sDebugText_FlagsVars_Flags[] =                  _("Set Flag XYZ…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
...
static const u8 sDebugText_FlagsVars_Vars[] =                   _("Set Var XYZ…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_FlagsVars_VariableHex[] =            _("{STR_VAR_1}{CLEAR_TEXT_TO 90}\n0x{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_FlagsVars_Variable[] =               _("Var: {STR_VAR_1}{CLEAR_TEXT_TO 90}\nVal: {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{STR_VAR_2}");
static const u8 sDebugText_FlagsVars_VariableValueSet[] =       _("Var: {STR_VAR_1}{CLEAR_TEXT_TO 90}\nVal: {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{STR_VAR_2}");
...
static const u8 sDebugText_ItemQuantity[] =             _("Quantity:{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n\n{STR_VAR_2}");
static const u8 sDebugText_ItemID[] =                   _("Item Id: {STR_VAR_3}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n\n{STR_VAR_2}");
static const u8 sDebugText_Give_AllTMs[] =              _("Give all TMs");
static const u8 sDebugText_Give_GivePokemonSimple[] =   _("Pkm (lvl)…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Give_GivePokemonComplex[] =  _("Pkm (l,s,n,a,IV,mov)…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_PokemonID[] =                _("Species: {STR_VAR_3}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonLevel[] =             _("Level:{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonShiny[] =             _("Shiny:{CLEAR_TEXT_TO 90}\n   {STR_VAR_2}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonNature[] =            _("NatureId: {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonAbility[] =           _("AbilityNum: {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonIVs[] =               _("All IVs:{CLEAR_TEXT_TO 90}\n    {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_IV_HP[] =                    _("IV HP:{CLEAR_TEXT_TO 90}\n    {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_IV_Attack[] =                _("IV Attack:{CLEAR_TEXT_TO 90}\n    {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_IV_Defense[] =               _("IV Defense:{CLEAR_TEXT_TO 90}\n    {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_IV_Speed[] =                 _("IV Speed:{CLEAR_TEXT_TO 90}\n    {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_IV_SpAttack[] =              _("IV Sp. Attack:{CLEAR_TEXT_TO 90}\n    {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_IV_SpDefense[] =             _("IV Sp. Defense:{CLEAR_TEXT_TO 90}\n    {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonMove_0[] =            _("Move 0: {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonMove_1[] =            _("Move 1: {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonMove_2[] =            _("Move 2: {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
static const u8 sDebugText_PokemonMove_3[] =            _("Move 3: {STR_VAR_3}{CLEAR_TEXT_TO 90}\n{STR_VAR_1}{CLEAR_TEXT_TO 90}\n{CLEAR_TEXT_TO 90}\n{STR_VAR_2}{CLEAR_TEXT_TO 90}");
...
// Sound Menu
static const u8 sDebugText_Sound_SFX[] =                _("SFX…{CLEAR_TEXT_TO 110}{RIGHT_ARROW}");
...
static const struct ListMenuItem sDebugMenu_Items_FlagsVars[] =
{
    ...
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_QUEST_LOG]     = {sDebugText_FlagsVars_SwitchQuestLog,     DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_QUEST_LOG},
};
...
static void (*const sDebugMenu_Actions_Flags[])(u8) =
{
    ...
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_QUEST_LOG]     = DebugAction_FlagsVars_QuestLogOnOff,
};
...
static u8 Debug_CheckToggleFlags(u8 id)
{
    ...
    switch (id)
    {
        ...
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_TRAINER_SEE:
            ...
            break;
    #endif
    #if OW_FLAG_DISABLE_QUEST_LOG != 0
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_QUEST_LOG:
            result = FlagGet(OW_FLAG_DISABLE_QUEST_LOG);
            break;
    #endif
        default:
            result = 0xFF;
...
static void DebugAction_FlagsVars_QuestLogOnOff(u8 taskId)
{
    ...
    if (FlagGet(OW_FLAG_DISABLE_QUEST_LOG))
        ...
        PlaySE(SE_PC_LOGIN);
    FlagToggle(OW_FLAG_DISABLE_QUEST_LOG);
#endif
}
...
static void DebugAction_Give_Item_SelectQuantity(u8 taskId)
{
    ...
    if (JOY_NEW(DPAD_ANY))
    {
        ...
        if (JOY_NEW(DPAD_UP))
        {
            u32 maxCapacity = (ItemId_GetPocket(itemId) - 1 == POCKET_BERRY_POUCH) ? MAX_BERRY_CAPACITY : MAX_BAG_ITEM_CAPACITY;
            gTasks[taskId].tInput += sPowersOfTen[gTasks[taskId].tDigit];
...
static void DebugAction_Fill_PCBoxes_Fast(u8 taskId) //Credit: Sierraffinity
{
    ...
    // this just needs to be any slow growth rate mon so the exp is set right for them
    u16 species = SPECIES_GROWLITHE;
    u8 speciesName[POKEMON_NAME_LENGTH + 1];
    u8 level = 100;
