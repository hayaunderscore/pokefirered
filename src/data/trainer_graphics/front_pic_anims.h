...
static const union AnimCmd *const sAnims_QueenAbby[] =
{
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Giselle[] =
{
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Cara[] =
{
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_Bret[] =
{
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_QUEEN_ABBY]            = sAnims_QueenAbby,
    [TRAINER_PIC_GISELLE]               = sAnims_Giselle,
    [TRAINER_PIC_CARA]                  = sAnims_Cara,
    [TRAINER_PIC_GHOST]                 = sAnims_Ghost,
    [TRAINER_PIC_BRET]                  = sAnims_Bret,
    [TRAINER_PIC_GOLD]                  = sAnims_Bret,
