static const u32 sSlidingPuzzle_Gfx[]     = INCGFX_U32("graphics/sliding_puzzle/bg.png", ".4bpp.lz");
static const u32 sSlidingPuzzle_Tilemap[] = INCGFX_U32("graphics/sliding_puzzle/map.bin", ".lz");
static const u16 sSlidingPuzzle_Pal[]     = INCGFX_U16("graphics/sliding_puzzle/bg.pal", ".gbapal");

static const u32 sCursor_Gfx[]      = INCGFX_U32("graphics/sliding_puzzle/cursor.png", ".4bpp.lz");
static const u16 sCursorTiles_Pal[] = INCGFX_U16("graphics/sliding_puzzle/cursor_tiles.pal", ".gbapal");
...
static const u8 sText_MoveQuit[]            = _("{DPAD_ANY}MOVE {B_BUTTON}QUIT");
static const u8 sText_MovePickUpQuit[]      = _("{DPAD_ANY}MOVE {A_BUTTON}PICK UP {B_BUTTON}QUIT");
static const u8 sText_MovePlaceRotateQuit[] = _("{DPAD_ANY}MOVE {A_BUTTON}PLACE {L_BUTTON}{R_BUTTON}ROTATE {B_BUTTON}QUIT");
static const u8 sText_MoveSwapRotateQuit[]  = _("{DPAD_ANY}MOVE {A_BUTTON}SWAP {L_BUTTON}{R_BUTTON}ROTATE {B_BUTTON}QUIT");
static const u8 sText_MoveRotateQuit[]      = _("{DPAD_ANY}MOVE {L_BUTTON}{R_BUTTON}ROTATE {B_BUTTON}QUIT");
