...
static const u16 sUnionRoomChatInterfacePal[] = INCGFX_U16("graphics/union_room_chat/objects.pal", ".gbapal");
static const u32 sSelectorCursor_Gfx[] = INCGFX_U32("graphics/union_room_chat/selector_cursor.png", ".4bpp.lz");
static const u32 sTextEntryCursor_Gfx[] = INCGFX_U32("graphics/union_room_chat/text_entry_cursor.png", ".4bpp.lz");
static const u32 sCharacterSelectCursor_Gfx[] = INCGFX_U32("graphics/union_room_chat/character_select_cursor.png", ".4bpp.lz");
static const u32 sRButton_Gfx[] = INCGFX_U32("graphics/union_room_chat/r_button.png", ".4bpp.lz");
