...
static const u16 sSpritePal_321Start[] = INCGFX_U16("graphics/misc/minigame_countdown.png", ".gbapal");
static const u16 sSpriteSheet_321Start[] = INCGFX_U16("graphics/misc/minigame_countdown.png", ".4bpp.lz");
