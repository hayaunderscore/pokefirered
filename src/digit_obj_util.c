...
const u16 gMinigameDigits_Pal[] = INCGFX_U16("graphics/misc/minigame_digits.png", ".gbapal");
const u32 gMinigameDigits_Gfx[] = INCGFX_U32("graphics/misc/minigame_digits.png", ".4bpp.lz");
static const u32 sUnusedMinigameDigits_Gfx[] = INCGFX_U32("graphics/misc/minigame_digits_unused.png", ".4bpp.lz");
