...
static const u8 sMonPosAttributes[][PSA_MON_ATTR_COUNT] = {
    ...
    [SPECIES_SAPUSAUR     - 1] = {32, 23,  8, 31, 33},
    [SPECIES_CHARCOLT     - 1] = {28, 25,  8, 27, 35},
    ...
    [SPECIES_PETILIL     - 1] = {32, 25,  8, 31, 35},
    [SPECIES_LILLIGANT     - 1] = {32, 21,  8, 31, 31},
    [SPECIES_UNOWN_KING     - 1] = {32, 25,  8, 31, 35},
