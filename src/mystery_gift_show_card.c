...
static const u16 sCard0Pal[] = INCGFX_U16("graphics/wonder_card/bg0.pal", ".gbapal");
const u16 gCard1Pal[] = INCGFX_U16("graphics/wonder_card/bg1.pal", ".gbapal");
const u16 gCard2Pal[] = INCGFX_U16("graphics/wonder_card/bg2.pal", ".gbapal");
const u16 gCard3Pal[] = INCGFX_U16("graphics/wonder_card/bg3.pal", ".gbapal");
const u16 gCard4Pal[] = INCGFX_U16("graphics/wonder_card/bg4.pal", ".gbapal");
const u16 gCard5Pal[] = INCGFX_U16("graphics/wonder_card/bg5.pal", ".gbapal");
static const u16 sCard6Pal[] = INCGFX_U16("graphics/wonder_card/bg6.pal", ".gbapal");
static const u16 sCard7Pal[] = INCGFX_U16("graphics/wonder_card/bg7.pal", ".gbapal");
static const u8 sCard0Gfx[] = INCGFX_U8("graphics/wonder_card/bg0.png", ".4bpp.lz");
static const u8 sCard0Map[] = INCGFX_U8("graphics/wonder_card/bg0.bin", ".lz");
static const u8 sCard1Gfx[] = INCGFX_U8("graphics/wonder_card/bg1.png", ".4bpp.lz");
static const u8 sCard1Map[] = INCGFX_U8("graphics/wonder_card/bg1.bin", ".lz");
static const u8 sCard2Gfx[] = INCGFX_U8("graphics/wonder_card/bg2.png", ".4bpp.lz");
static const u8 sCard2Map[] = INCGFX_U8("graphics/wonder_card/bg2.bin", ".lz");
static const u8 sCard6Gfx[] = INCGFX_U8("graphics/wonder_card/bg6.png", ".4bpp.lz");
static const u8 sCard6Map[] = INCGFX_U8("graphics/wonder_card/bg6.bin", ".lz");
static const u8 sCard7Gfx[] = INCGFX_U8("graphics/wonder_card/bg7.png", ".4bpp.lz");
static const u8 sCard7Map[] = INCGFX_U8("graphics/wonder_card/bg7.bin", ".lz");
static const u16 sStampShadowPal0[] = INCGFX_U16("graphics/wonder_card/stamp_shadow_0.pal", ".gbapal");
