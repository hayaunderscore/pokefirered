...
static const u8 sTextColorTable[] =
{
 // [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    ...
    [OBJ_EVENT_GFX_ROXANNE / 2]					= COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_GISELLE
    [OBJ_EVENT_GFX_JOE / 2]						= COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_RS_REPORTER
    [OBJ_EVENT_GFX_RS_CAMERAMAN / 2]            = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_FEMALE),
};
