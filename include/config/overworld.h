...
#define OW_FLAG_NO_COLLISION            FLAG_SYS_WALK_THROUGH_WALLS       // If this flag is set, the player will be able to walk over tiles with collision. Mainly intended for debugging purposes.
