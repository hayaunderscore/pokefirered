...
static const u16 sMarkerPal[] = INCGFX_U16("graphics/pokedex/area_markers/marker.pal", ".gbapal");
static const u32 sMarkerTiles[] = INCGFX_U32("graphics/pokedex/area_markers/marker.4bpp", ".lz");
