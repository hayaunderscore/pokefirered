...
#define CADMIUM_SPECIES_START 252

static const u16 sCadmiumSpeciesIdToCryId[] =
{
	[SPECIES_RAINER - CADMIUM_SPECIES_START] = CRY_CHIMECHO + 1,
	[SPECIES_PETILIL - CADMIUM_SPECIES_START] = CRY_CHIMECHO + 2,
	[SPECIES_LILLIGANT - CADMIUM_SPECIES_START] = CRY_CHIMECHO + 3,
	[SPECIES_UNOWN_KING - CADMIUM_SPECIES_START] = CRY_CHIMECHO + 4,
};
